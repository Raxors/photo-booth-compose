...
fun FriendListScreen(
    ...
    val incoming = viewModel.getIncomingListStateFlow().collectAsLazyPagingItems()
    val outgoing = viewModel.getOutgoingListStateFlow().collectAsLazyPagingItems()
    val friends = viewModel.getFriendListStateFlow().collectAsLazyPagingItems()
    val searchResult = viewModel.getSearchListStateFlow().collectAsLazyPagingItems()
